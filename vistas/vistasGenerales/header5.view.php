<!DOCTYPE html>
	...
	<html lang="es">
		...
		<script type="text/javascript" src="layout/scripts/js/ajax/inserta.js?v=1.0.10"></script>

		<!-- acciones datatablets -->
		<script type="text/javascript" src="layout/scripts/js/ajax/acciones.js?v=1.0.8"></script>

		<!-- datablets -->
		<script type="text/javascript" src="layout/scripts/js/ajax/datatablet.js?v=1.0.83"></script>
