...
<?php $arrayInformacion=$objeto->getObtenerInformacionGeneral("SELECT a.idComponentes,a.nombreComponentes FROM poa_paid_componentes AS a INNER JOIN poa_paid_componentes_rubros AS b ON a.idComponentes=b.idComponente WHERE a.identificador='2' GROUP BY a.idComponentes;");?>
