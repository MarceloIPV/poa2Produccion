		...
		<table class="col col-12 cell-border">
			...
			<tbody>
				<tr>
					...
					<td><center><button class="btn btn-success"  data-toggle="modal" data-target="#nuevoItem" onclick="historial_sueldos_salarios7()">Ver</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <option value="value1">COODINADOR ZONAL</option>
  <option value="value3">DIRECTOR MINSTERIO DEL DEPORTE</option>
  <
</select>
 <a href="php/prueba5.pdf" target="_blank">Descargar informe</a> 
 <form action="php/prueba5-signed.pdf" method="post" enctype="multipart/form-data" target="_blank">
  <p>
    Subir archivo:
