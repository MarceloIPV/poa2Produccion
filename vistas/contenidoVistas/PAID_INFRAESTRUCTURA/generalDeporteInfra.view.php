...
<input type="hidden" id="ïdentificador" name="ïdentificador" value="2">
...
<div class="content-wrapper d  flex-column align-items-center">
	...
	<div id="divReportePAIDGeneralDesarrollo">
		...
		<table id="paidReporteGeneralInfra">
...
<script>
	...
	$( document ).ready(function() {
		$.getScript("layout/scripts/js/PAID_INFRAESTRUCTURA/selector.js", function() {
			...
			AsignarMontoPlanificadosGENERALTOTALInfraestructura("obtener_valor_total_paid_infraestructura_general",$("#montoPaidGeneralDesarrollo").attr("valor"), $("#identificador").val(),"montoAsignadoPaidGeneralDesarrollo","montoPorAsignarPaidGeneralDesarrollo");  
	...
	$.getScript("layout/scripts/js/PAID_DESARROLLO_JS/datatablets.js", function() {
		...
		datatabletsDesarollo($("#paidReporteGeneralInfra"), "paidReporteGeneralInfra");
