...
<div class="content-wrapper">
	...
	<section class="content row d d-flex justify-content-center">
		...
		<table id="reasignacionModificaciones__recomendaciones__planificacion__recomendacion" class="col col-12 cell-border">
...
<?=$componentesModificacion->recomendacion__modificacion__planificacion__recomendacion("modalModificaciones__reasignaciones");?>
