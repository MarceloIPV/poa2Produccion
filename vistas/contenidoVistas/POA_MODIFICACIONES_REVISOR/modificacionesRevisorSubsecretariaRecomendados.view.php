...
<div class="content-wrapper">
	...
	<section class="content row d d-flex justify-content-center">
		...
		<table id="reasignacionModificaciones__recomendaciones__subsess" class="col col-12 cell-border">
...
<?=$componentesModificacion->recomendacion__modificacion("modalModificaciones__reasignaciones");?>
