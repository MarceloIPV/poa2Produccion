...
<div class="content-wrapper">
	...
	<section class="content row d d-flex justify-content-center">
		...
		<?=$componentes->getComponentes(1,"Necesidades Individuales");?>
		...
		<div class="row">
			...
			<table id="paidRubrosNecesidadesIndividuales" class="col col-12 cell-border">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="row">
									...
									<div class="col-md-6">
									<input type="number" id="cantidad" oninput="necesidadesIndividualesValorTotal()" class="form-control" >		
									</div>
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="row">
									...
									<div class="col-md-6">
											<input type="number" id="valorUnitario" oninput="necesidadesIndividualesValorTotal()" class="form-control" >				
									</div>
								</div>
							</div>
					...
					<div class="modal-footer">
						<button type="button" onclick="rubroGuardarNuevoNecesidadesIndividuales()" class="btn btn-primary" data-dismiss="modal">Guardar</button>
