...
<section class='content row mt-4 borde__separacion__mo' style='padding:.5em;'>
  ...
  <table class='col col-12 table__bordes__ejecutados mt-4'>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <select id='actividad__modificaciones__destino__modificaciones2_o' class='ancho__total__input obligatorios'></select>
        </td>
        ...
        ?>
         ...
         <td>
          ...
          <select id='meses2_o' class='ancho__total__input obligatorios'>
 ...
 echo "  <option value=".$meses[$i]." onclick='pasar_valor1($numero)'>".$meses[$i]." - ".$numero."</option>";
           } 
        ...
        <td>
          <input  type="number" id='monto__seleccionados__destino__new2_o' oninput="valorCambio(),valorSuperior()" class='ancho__total__input obligatorios' />
          <input  type="text" id='monto__seleccionados__destino__new2_o1' oninput="valorSuperior()" class='ancho__total__input obligatorios' />
  ...
  <table class='col col-12 table__bordes__ejecutados mt-4'>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <select id='actividad__modificaciones__destino__modificaciones2' onclick="cargar_nuevoevento()" class='ancho__total__input obligatorios'></select>
        </td>
        ...
        <td>
         <button class="form-control btn btn-primary" onclick="modificacion_destino_todos()">Guardar</button>
       </td>
