...
<div class="content-wrapper">
	...
	<section class="content row d d-flex justify-content-center">
		...
		<?=$componentes->getComponentes(1,"Coordinación DE Ifraestructura Deportiva Financiera");?>
		...
		<table class="col col-12 cell-border">
			...
			<tbody>
				<tr>
					...
					<td><center><button class="btn btn-success"  data-toggle="modal" data-target="#nuevoItem" onclick="historial_sueldos_salarios2()">Ver</button>
