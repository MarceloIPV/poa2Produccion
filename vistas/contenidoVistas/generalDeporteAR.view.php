			...
			<table id="" class="col col-12 cell-border">
				...
				<tbody>
					<tr align="center">						
						...
						$sql="SELECT * FROM poa_paid_asignacion_dos where idOrganismo='$idOrganismoSession' and estado='A' and perioIngreso='$aniosPeriodos__ingesos' limit 1;";
...
<thead>
					...
					<tr align="center">
							...
							<?php 
									$objeto1= new usuarioAcciones();
									$indicadorInformacion1=$objeto1->getObtenerInformacionGeneral("SELECT nombreRubros,a.idRubros, montos from poa_paid_asignacion as a,poa_paid_rubros as b where a.idRubros=b.idRubros and a.idOrganismo='$idOrganismoSession' and a.perioIngreso='$aniosPeriodos__ingesos' order by nombreRubros asc;");
									$jason['indicadorInformacion']=$indicadorInformacion1;
							     	echo "<thead></th><thead>";
									foreach ($indicadorInformacion1 as $row1)
									{
										...
										echo "<th COLSPAN=1><center>$nombre </center></th>";
				...
				<tr>
									...
									foreach ($indicadorInformacion1 as $row1)
									{
										...
										$id= $row1["idRubros"];										
										$montos= $row1["montos"];
										$valorTotal=number_format($montos,2,'.','');										
										echo "<td><center>$$valorTotal</center></td>";										
									}									
									?>
<tr>
									</table>
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-12">
									...
									<?php 
									$objeto1= new usuarioAcciones();
									$indicadorInformacion1=$objeto1->getObtenerInformacionGeneral("SELECT nombreRubros,a.idRubros, montos from poa_paid_asignacion as a,poa_paid_rubros as b where a.idRubros=b.idRubros and idOrganismo='$idOrganismoSession';");
									$jason['indicadorInformacion']=$indicadorInformacion1;
									...
									foreach ($indicadorInformacion1 as $row1)
									{
										...
										if ($vt == 0) {
											...
											echo "<option value='".$id."' onclick='rubrosItemsCragar(".$id.",".$montos."),valorFalta(".$id.",".$montos.")'>".$nombre." </option>";
						...
						<div class="col-md-2">
							<div class="row">
								<div class="col-md-12">
									...
									<input  class="form-control" type="text" id="valorAsignado" readonly="<?=$valora?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<table id="" class="col col-12 cell-border " > 
								...
								<tbody>
									...
									<td><button class="form-control btn btn-success" onclick="guardarNuevoPaidGeneral()">Guardar</button>
									</td>
								</tr>
							</tbody>
						</table>
			...
			<div class="modal-body">
						...
						<div class="row">
							...
							<table id="" class="col col-12 cell-border " > 
								...
								<tbody>
									...
									<td><button class="form-control btn btn-success" onclick="guardarNuevoPaidIndicadores()">Guardar</button>
									</td>
								</tr>
							</tbody>
						</table>
				...
				<div class="modal-footer">
					<div class="col-md-12" class="col col-12 cell-border"  style="overflow: scroll;">
						...
						<table id="paidRubrosIndicadores" >
