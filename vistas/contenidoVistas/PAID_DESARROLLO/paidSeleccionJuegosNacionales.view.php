...
<?= $componentesPaid->getModal_matrices_hosp_alim("modalHospAlimDI", "Hospedaje-Alimentación - Deporte Individual", 'cerrarHospAlimDI', "SelectItemHosp_Alim1", "SelectItemHosp_Alim2", "deporteHospAlimDI", "nroCuposHospAlimDI", "HospAlimDI", "diasHospAlimDI", "valorTotalHospAlimDI", "guardarHospAlimDI"); ?>
<?= $componentesPaid->getModal_matrices_hosp_alimDC("modalHospAlimDC", "Hospedaje-Alimentación - Deporte en Conjunto", 'cerrarHospAlimDC', "SelectItemHosp_AlimDC1", "SelectItemHosp_AlimDC2", "deporteHospAlimDC", "nroCuposHospAlimDC", "HospAlimDC", "diasHospAlimDC", "valorTotalHospAlimDC", "guardarHospAlimDC"); ?>
<?= $componentesPaid->getModal_matrices_hosp_alim_JA("modalDeporteDelegacionHospAlimJA", "Juegos Ancestrales - Hospedaje-Alimentación", 'cerrarHospAlimJA', "SelectItemHosp_AlimJA1",  "SelectItemHosp_AlimJA2 ", "deporteHospAlimJA", "nroCuposHospAlimJA", "HospAlimJA", "diasHospAlimJA", "valorTotalHospAlimJA", "guardarHospAlimJA"); ?>
<?= $componentesPaid->getModal_matrices_hosp_alimHIDI("modalHidratacionDI", "Hidratación - Deporte Individual", 'cerrarHidratacionDI', "SelectItemHidratacionDI", "deporteHidratacionDI", "nroCuposHidratacionDI", "HidratacionDI", "diasHidratacionDI", "valorTotalHidratacionDI", "guardarHidratacionDI"); ?>
<?= $componentesPaid->getModal_matrices_HidrDC("modalHidratacionDC", "Hidratación - Deporte en Conjunto", 'cerrarHidratacionDC', "SelectItemHidratacionDC", "deporteHidratacionDC", "nroCuposHidratacionDC", "HidratacionDC", "diasHidratacionDC", "valorTotalHidratacionDC", "guardarHidratacionDC"); ?>
<?= $componentesPaid->getModal_matrices_HidrJA("modalDeporteDelegacionHidrJA", "Juegos Ancestrales - Hidratación", 'cerrarHidratacionJA', "SelectItemHidratacionJA", "deporteHidratacionJA", "nroCuposHidratacionJA", "HidratacionJA", "diasHidratacionJA", "valorTotalHidratacionJA", "guardarHidratacionJA"); ?>
