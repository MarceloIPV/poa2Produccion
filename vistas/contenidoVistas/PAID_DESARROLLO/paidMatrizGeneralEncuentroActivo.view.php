...
<?= $componentesPaid->getModal_matrices_general__paid("modalAdecentamiento","Adecentamiento",'cerrarAdecentamiento',"itemAdecentamiento","descripcionAdecentamiento","valorTotalAdecentamiento","guardarAdecentamiento"); ?>
<?= $componentesPaid->getModal_matrices_general__paid("ModalBienes","Bienes",'cerrarBienes',"itemBienes","descripcionBienes","valorTotalBienes","guardarBienes"); ?>
<?= $componentesPaid->getModal_matrices_general_Item_estatico_paid("ModalMedicinas","Medicinas",'cerrarMedicinas',"itemMedicinas","(530809) - Medicinas y Productos de farmacia ","210","descripcionMedicinas","valorTotalMedicinas","guardarMedicinas"); ?>
<?= $componentesPaid->getModal_matrices_general__paid("ModalAlqEquipos","Alquiler de Equipos",'cerrarAlqEquipos',"itemAlqEquipos","descripcionAlqEquipos","valorTotalAlqEquipos","guardarAlqEquipos"); ?>
<?= $componentesPaid->getModal_matrices_general__paid("ModalComEquipos","Compra de Equipos",'cerrarComEquipos',"itemComEquipos","descripcionComEquipos","valorTotalComEquipos","guardarComEquipos"); ?>
<?= $componentesPaid->getModal_matrices_general__paid("ModalLogEvnetos","Logística de Eventos",'cerrarLogEventos',"itemLogEventos","descripcionLogEventos","valorTotalLogEventos","guardarLogEventos"); ?>
<?= $componentesPaid->getModal_matrices_general_Item_estatico_paid("ModalPublicidad","Publicidad",'cerrarPublicidad',"itemPublicidad","(530204) - Edición, Impresión, Reproducción, Publicaciones, Suscripciones, Fotocopiado, Traducción, Empastado, Enmarcación, Serigrafía, Fotografía, Carnetización, Filmación e Imágenes Satelitales.","191","descripcionPublicidad","valorTotalPublicidad","guardarPublicidad"); ?>   
<?= $componentesPaid->getModal_acreditaciones__paid("ModalAcreditaciones","Acreditaciones",'cerrarAcreditaciones',"itemAcreditaciones","(530204) - Edición, Impresión, Reproducción, Publicaciones, Suscripciones, Fotocopiado, Traducción, Empastado, Enmarcación, Serigrafía, Fotografía, Carnetización, Filmación e Imágenes Satelitales.","191","descripcionAcreditaciones","cantidadAcreditaciones","valorUnitarioAcreditaciones","valorTotalAcreditaciones","guardarAcreditaciones"); ?>       
