	...
	<div class="contenidos__formularios__enviados">
		...
		<div class="contenedor__seguimiento__sin">
			...
			<section class="content row d d-flex justify-content-left align-items-center mt-4">
				...
				<?php else: ?>
					<?= $componentes->getLinksConfiguracion__parametros__ver(["indicadoresM_estadoCuenta"], ["Indicadores"], "idIndicadores_estadoCuenta", ["indicadoresMEindicadoresM_estadoCuenta"], 'idIndicadoresME'); ?>
				<?php endif ?>
...
<?= $componentesTablas->getModalConfiguracion__modificacion("indicadoresM", "Indicadores", "lineaPoliticaContent", "dt_segui_indicadores"); ?>
...
<?= $componentesTablas->getModalConfiguracion__competencia__tecnica__formativa("competencia__formativaSM", "005 - Eventos de preparación y competencia - Deporte Formativo - Información técnica", "mantenimiento__competencia__formativa__content","dt_segui_deporte_formativo"); ?>
...
<?= $componentesPaid->get__contraloria_items__paid("contrataciones__NoitemsSeguimiento", "formContratacionPublica", "Sin Contratación Pública", "divNoContratacionPublicaSeguimiento", "cerrarBtnNoContratacionPublica", "inputIdItem"); ?>
...
<?= $componentesTablas->get__modal__edicion__parametros("cpacitacionME", "003 - Capacitación deportiva o de recreación - Ejecución presupuestaria (Ver)", "<div class='col col-12'><a class='btn btn-primary' id='exportar__capacitacion'>Exportar a excel</a></div><br><table id='capacitacion__seguimientos'><thead><tr><th style='vertical-align:middle;'><center>Mes</center></th><th style='vertical-align:middle;'><center>Código</center></th><th style='vertical-align:middle;'><center>Ítem</center></th><th style='vertical-align:middle;'><center>Monto<br>programado</center></th><th><center>Monto<br>ejecutado</center></th><th><center>Registra Contratación</center></th><th><center>Justificación</center></th><th style='vertical-align:middle;'><center>Acciones</center></th></tr></thead><tbody class='cuerpo__capacitacion__vs'></tbody></table><table id='capacitacion__seguimientos__2' style='display:none!important;'><thead><tr><th style='vertical-align:middle;'><center>Mes</center></th><th style='vertical-align:middle;'><center>Código</center></th><th style='vertical-align:middle;'><center>Ítem</center></th><th style='vertical-align:middle;'><center>Monto<br>programado</center></th><th><center>Monto<br>ejecutado</center></th></tr></thead><tbody class='cuerpo__capacitacion__vs__2'></tbody></table><table id='capacitacion__factureros__v'><thead><tr><th><center>Código Ítem</center></th><th><center>Nombre Ítem</center></th><th><center>Documento</center></th><th><center>Número de factura</center></th><th><center>Fecha<br>factura</center></th><th><center>Ruc</center></th><th><center>Autorización</center></th><th><center>Monto</center></th><th><center>Mes</center></th><th>Trimestre</th><th><center>Acciones</center></th></tr></thead><tbody class='factureros__implementacion'></tbody></table><table id='capacitacion__otros__ver'><thead><tr><th><center>Código Ítem</center></th><th><center>Nombre Ítem</center></th><th><center>Documento</center></th><th><center>Mes</center></th><th><center>Trimestre</center></th><th><center>Acciones</center></th></tr></thead><tbody class='otros__implementacion'></tbody></table>"); ?>
...
<?= $componentesTablas->get__modal__edicion__parametros("implementacionME", "007 - implementación deportiva  - Ejecución presupuestaria e Información Técnica (Ver)", "<div class='col col-12'><a class='btn btn-primary' id='exportar__implementacion'>Exportar a excel</a></div><br><table id='implementacion__seguimientos'><thead><tr><th style='vertical-align:middle;'><center>Mes</center></th><th style='vertical-align:middle;'><center>Código</center></th><th style='vertical-align:middle;'><center>Ítem</center></th><th style='vertical-align:middle;'><center>Monto<br>programado</center></th><th><center>Monto<br>ejecutado</center></th><th><center>Observaciones</center></th><th><center>Cantidad</center></th><th><center>Registra Contratación</center></th><th><center>Justificación</center></th><th style='vertical-align:middle;'><center>Acciones</center></th></tr></thead><tbody class='cuerpo__competencia__implementaciones'></tbody></table><table id='implementacion__seguimientos__2' style='display:none!important;'><thead><tr><th style='vertical-align:middle;'><center>Mes</center></th><th style='vertical-align:middle;'><center>Código</center></th><th style='vertical-align:middle;'><center>Ítem</center></th><th style='vertical-align:middle;'><center>Monto<br>programado</center></th><th><center>Monto<br>ejecutado</center></th><th><center>Observaciones</center></th><th><center>Cantidad</center></th>    </tr></thead><tbody class='cuerpo__competencia__implementaciones__2'></tbody></table><table id='factureros__implementarciones__ver'><thead><tr><th><center>Código Ítem</center></th><th><center>Nombre Ítem</center></th><th><center>Documento</center></th><th><center>Número de factura</center></th><th><center>Fecha<br>factura</center></th><th><center>Ruc</center></th><th><center>Autorización</center></th><th><center>Monto</center></th><th><center>Mes</center></th><th>Trimestre</th><th><center>Acciones</center></th></tr></thead><tbody class='factureros__implementacion'></tbody></table><table id='otros__implementaciones__ver'><thead><tr><th><center>Código Ítem</center></th><th><center>Nombre Ítem</center></th><th><center>Documento</center></th><th><center>Mes</center></th><th><center>Trimestre</center></th><th><center>Acciones</center></th></tr></thead><tbody class='otros__implementacion'></tbody></table>"); ?>

<?= $componentesTablas->get__modal__edicion__parametros("indicadoresMEindicadoresM_estadoCuenta", "Indicadores (Ver)", "<div class='col col-12'><a class='btn btn-primary' id='exportar__indicadores'>Exportar a excel</a></div><br><table id='indicadores__seguimientos'><thead><tr><th style='vertical-align:middle;'><center>Código<br>actividad</center></th><th style='vertical-align:middle;'><center>Nombre de <br>actividad</center></th><th style='vertical-align:middle;'><center>Indicador</center></th><th><center>Meta<br>programada</center></th><th style='vertical-align:middle;'><center>Meta<br>alcanzada</center></th><th style='vertical-align:middle;'><center>Documento<br>sustento</center></th><th style='vertical-align:middle;'><center>Acciones</center></th></tr></thead><tbody class='cuerpo__indicadores__seguimientos'></tbody></table><table id='indicadores__seguimientos__2' style='display:none!important;'><thead><tr><th style='vertical-align:middle;'><center>Código<br>actividad</center></th><th style='vertical-align:middle;'><center>Nombre<br>actividad</center></th><th style='vertical-align:middle;'><center>Indicador</center></th><th><center>Total<br>programado</center></th><th style='vertical-align:middle;'><center>Total<br>ejecutado</center></th></tr></thead><tbody class='cuerpo__indicadores__seguimientos__2'></tbody></table></table><table id='indicadores__seguimientos__2__estado_cuenta'><thead><tr><th><center>Fecha</center></th><th><center>Trimestre</center></th><th><center>Documento</center></th><th><center>Acciones</center></th></tr></thead><tbody class='cuerpo__indicadores__seguimientos__2__estado__cuenta'></tbody></table>"); ?>
