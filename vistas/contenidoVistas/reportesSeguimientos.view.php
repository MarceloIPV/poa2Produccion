...
<?php $reporteTecnicosI=$objetoInformacion->getObtenerInformacionGeneral("SELECT archivo FROM poa_seguimiento_recomendado_tecnico WHERE trimestre='primerTrimestre' AND perioIngreso='$aniosPeriodos__ingesos' AND idOrganismo='$idOrganismo' AND perioIngreso='$aniosPeriodos__ingesos' ORDER BY idInformacionEnviada DESC LIMIT 1;");?>
...
<?php $reporteTecnicosII=$objetoInformacion->getObtenerInformacionGeneral("SELECT archivo FROM poa_seguimiento_recomendado_tecnico WHERE trimestre='segundoTrimestre' AND perioIngreso='$aniosPeriodos__ingesos' AND idOrganismo='$idOrganismo' ORDER BY idInformacionEnviada DESC LIMIT 1;");?>
...
<?php $reporteTecnicosIII=$objetoInformacion->getObtenerInformacionGeneral("SELECT archivo FROM poa_seguimiento_recomendado_tecnico WHERE trimestre='tercerTrimestre' AND perioIngreso='$aniosPeriodos__ingesos' AND idOrganismo='$idOrganismo'  ORDER BY idInformacionEnviada DESC LIMIT 1;");?>
...
<?php $reporteTecnicosIV=$objetoInformacion->getObtenerInformacionGeneral("SELECT archivo FROM poa_seguimiento_recomendado_tecnico WHERE trimestre='cuartoTrimestre' AND perioIngreso='$aniosPeriodos__ingesos' AND idOrganismo='$idOrganismo' ORDER BY idInformacionEnviada DESC LIMIT 1;");?>
