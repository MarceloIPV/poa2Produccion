		...
		<table class="col col-12 cell-border">
			...
			<tbody>
				<tr>
					...
					<td><center><button class="btn btn-success"  data-toggle="modal" data-target="#nuevoItem" onclick="historial_sueldos_salarios5()">Ver</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">An</h5>
