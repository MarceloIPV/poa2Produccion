...
<div class="content-wrapper">
	...
	<div class="col col-12 text-center mt-2 titulo__enfasis">
		...
		<div class=" mt-4">
			...
			<table id="seguimiento__reportes__anexos2023" class="col col-12 cell-border">
...
<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("indicadores__se__2","Indicadores","seguimiento__indicadores__2",["Actividad","Trimestre","Año","Total programado","Total ejecutado","Documento"]);?>
...
<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("mantenimiento__se__2","002 - Mantenimiento de escenarios e infraestructura deportiva - Ejecución presupuestaria","seguimiento__mantenimientos__2",["Año","Trimestre","Mes","Código del Item","Ítem","Monto Programado","Monto ejecutado"]);?>
...
<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("capacitacion__se__2","003 - Capacitación deportiva o de recreación - Ejecución presupuestaria","seguimiento__capacitacion__2",["Año","Trimestre","Mes","Código del Item","Ítem","Monto Programado","Monto ejecutado"]);?>
...
<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("sueldos__se__2","004 - Operación deportiva - Sueldos y salarios","seguimiento__sueldos__salarios__2",['Actividad',"Cédula","Nombre","Sueldo planificado","Sueldo ejecutado","Aporte Iess planificado","Aporte Iess ejectuado","Décimo tercero planificado","Décimo tercero ejecutado","Décimo cuarto planificado","Décimo cuarto ejecutado","Fondos de Reserva Planificado","Fondos de Reserva Ejecutado","Deshaucio Planificado","Deshaucio Ejecutado","Despido Intempestivo Planificado","Despido Intempestivo Ejecutado","Renuncia Voluntaria Planificado","Renuncia Voluntaria Ejecutado","Vacaciones Planificado","Vacaciones Ejecutado","Mes","Trimestre","Año"]);?>

<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("honorarios__se__2","004 - Operación deportiva - Honorarios","seguimiento__honorarios__2",["Actividad","Cédula","Nombres","Mes","Trimestre","Año","Mensual programado","Mensual ejecutado"]);?>

<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("competencia__se__2","005 - Eventos de preparación y competencia - Ejecución presupuestaria","seguimiento__competencia__2",["Año","Trimestre","Mes","Código del Item","Ítem","Monto Programado","Monto ejecutado"]);?>
...
<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("recreativo__se__2","006 - Actividades recreativas - Ejecución presupuestaria","seguimiento__recreativo__2",["Año","Trimestre","Mes","Código del Item","Ítem","Monto Programado","Monto ejecutado"]);?>
...
<?=$componentesTablas->getModalConfiguracion__reporteria__organismos__seguimientos2("implementacion__se__2","007 - implementación deportiva  - Ejecución presupuestaria e Información Técnica","seguimiento__implementacion__2",["Año","Trimestre","Mes","Código del Item","Ítem","Monto Programado","Monto ejecutado"]);?>
