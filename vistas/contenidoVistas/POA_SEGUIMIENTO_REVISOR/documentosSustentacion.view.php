...
$.getScript("layout/scripts/js/POA_SEGUIMIENTO_REVISOR/datatables.js",function(){
	...
	datatabletsSeguimientoRevisorVacio($("#documentos__verificasDocumentacion"),"documentos__verificasDocumentacion","Reportes y Anexos",objetosSeguimiento2023([8,10,12,14],["enlaces__enviado__documento","enlaces__enviado__documento","enlaces__enviado__documento","enlaces__enviado__documento"],[8,10,12,14],["documentos/declaracionTerminos/","documentos/declaracionTerminos/", "documentos/declaracionTerminos/", "documentos/declaracionTerminos/"],["documento","documento2","documento3","documento4"],["documento","documento2","documento3","documento4"]),[$("#idUsuarioPrincipal").val(),$("#zonalUsuario").val(),$("#idRolAd").val()],false);	
