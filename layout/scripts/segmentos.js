					    	...
					    	success:function(response){
				            	...
				            	if (idActividades==2) {
				            		...
				            		$.getScript("layout/scripts/js/poaConstruccion/matrizConstruccion.js",function(){
										...
										enlacesMatriz($("#enlaceMatriz"+idActividades),['CÓDIGO ÍTEM','ÍTEM','Nombre de la infraestructura o escenario deportivo','Provincia','Dirección completa','Estado','Tipo de recursos con los que se construyó','Tipo de Intervención','Detallar el tipo de intervención que se ha planificado realizar','Tipo de Mantenimiento','Materiales o Servicios a requerir para el mantenimiento','Fecha de últipo mantenimiento realizado','Tipo de Contratación (Campo obligatorio para ingresar la información)'],headMeses,'Total de programación financiera',idActividades,"poa__mantenimiento",true);
