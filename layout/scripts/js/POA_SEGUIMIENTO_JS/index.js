$(document).ready(function () {
   ...
   $.getScript("layout/scripts/js/POA_SEGUIMIENTO_JS/selector.js",function(){
    ...
    $.getScript("layout/scripts/js/POA_SEGUIMIENTO_JS/metodos2.js",function(){
        ...
        funcion_click_boton_datatable_Honorarios(".cuerpo__honorarios__seguimientos","a.btnFacturas","divDocumentos","#idTituloModalDocumentos","Facturas Honorarios","facturasHonorarios","tbodyFacturaHonorarios",["Cédula","Nombre","Documento","Número de factura","Fecha factura","Ruc","Autorización","Monto","Mes","Trimestre","Acciones"],"honorarios__seguimientos__tablas","documentos/seguimiento/facturasMantenimiento/")
        funcion_click_boton_datatable_Honorarios(".cuerpo__honorarios__seguimientos","a.btnDocumentos","divDocumentos","#idTituloModalDocumentos","Documentos Honorarios","DocumentosHonorarios","tbodyDocumentosHonorarios",["Cédula","Nombre","Documento","Mes","Trimestre","Acciones"],"honorarios__seguimientos__tablas","documentos/seguimiento/otrosMantenimiento/")
        ...
        agregarDatatablets($("#documentacionGenerada__in"),"seguimiento__documentacionGenerada","Uso_Correcto_Recursos",objetos([2],["enlace"],['documento'],["../../documentos/seguimiento/declaracion_contratacion_publica/"],["documento"]),"");
        agregarDatatablets($("#documentacionGenerada__in__final"),"seguimiento__documentacionGenerada__2","Reporte_Trimestral",objetos([2],["enlace"],['documentoSIF'],["documentos/final__seguimiento/"],["documentoSIF"]),"");
        ...
        agregarDatatablets($("#btn_documentacion__Generada__cp"),"dt_seguimiento__documentacionGenerada_cp","Uso_Correcto_Contratacion_Publica",objetos([2],["enlace"],['documentoCP'],["documentos/declaracionTerminos/"],["documentoCP"]),"");
