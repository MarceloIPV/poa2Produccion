...
var checkeds__recorridos__general__tecnicos__matenimientos=function(parametro1,parametro2,parametro3,parametro4,parameto5,parametro6,parametro7,parametro8,parametro9,parametro10,parametro11,parametro12,parametro13,parametro14){
	...
	$(parametro2).click(function(e){
		...
		$.getScript("layout/scripts/js/POA_SEGUIMIENTO_JS_2022/validacionesGenerales.js",function(){
			...
			if (condicion) {
				...
				if(!$("#filaIndicadora").length > 0){
					...
					$("#guardar"+parametro6[0]).click(function(e) {
						...
						funcion__guardado__general($("#guardar"+idContador),$(".obligatorios__no"),[$("#totalProgramado"+idContador).val(),$("#totalEjecutado"+idContador).val(),parametro7,idContador,parametro8],$("#documentoSustento"+idContador),"seguimiento__indicadores",$(".filaIndicadora"+idContador),$(".oculto__trimestrales"));
