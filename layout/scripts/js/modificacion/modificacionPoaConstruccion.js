		...
		$.ajax({
			...
			success:function(response){
				...
				if (parametro6!="poa__actividadesDeportivas") {
					...
					if (parametro3!=false && parametro6!="actividad__administrativa") {
									...
									success:function(response){
										...
										for (x of informacion__obtenidas) {  
											...
											if (cuentas==1 || cuentas==10 || cuentas==20 || cuentas==30 || cuentas==40 || cuentas==50 || cuentas==60) {
												...
												$(".mantenimientos__necesarios__2").append("<tr class='filas__editables__"+x.idMantenimiento+"'><td class='bg-warning'>Ítem</td><td class='bg-warning'>Nombre de la infraestructura o escenario deportivo</td><td class='bg-warning'>Provincia</td><td class='bg-warning'>Dirección completa</td><td class='bg-warning'>Estado</td><td class='bg-warning'>Tipo de recursos con los que se construyó</td><td class='bg-warning'>Tipo de Intervención</td><td class='bg-warning'>Detallar el tipo de intervención que se ha planificado realizar</td><td class='bg-warning'>Tipo de Mantenimiento</td><td class='bg-warning'>Materiales o Servicios a requerir para el mantenimiento</td><td class='bg-warning'>Fecha de últipo mantenimiento realizado</td></tr>");

											}


											$(".mantenimientos__necesarios__2").append("<tr class='filas__editables__"+x.idMantenimiento+"'><td>"+x.nombreItem+"</td><td><input type='text' class='editar__enlaces"+x.idMantenimiento+"' attr='nombreInfras' value='"+x.nombreInfras+"' style='width:100%;'/></td><td><select class='editar__enlaces__selector"+x.idMantenimiento+" provinciasEn"+x.idMantenimiento+"' attr='provincia'  style='width:100%;'><option value='1'>Esmeraldas</option><option value='2'>Carchi</option><option value='3'>Imbabura</option><option value='4'>Sucumbios</option><option value='5'>Manabi</option><option value='6'>Santo Domingo de los Tsachilas</option><option value='7'>Pichincha</option><option value='8'>Napo</option><option value='9'>Orellana</option><option value='10'>Pastaza</option><option value='11'>Los Rios</option><option value='12'>Cotopaxi</option><option value='13'>Bolivar</option><option value='14'>Tungurahua</option><option value='15'>Chimborazo</option><option value='16'>Morona Santiago</option><option value='17'>Guayas</option><option value='18'>Santa Elena</option><option value='19'>Canar</option><option value='20'>Azuay</option><option value='21'>El Oro</option><option value='22'>Loja</option><option value='23'>Zamora Chinchipe</option><option value='24'>Galapagos</option><option value='25'>Internacional</option></select></td><td><input type='text' class='editar__enlaces"+x.idMantenimiento+"' attr='direccionCompleta' value='"+x.direccionCompleta+"'style='width:100%;' /></td><td><select class='editar__enlaces__selector"+x.idMantenimiento+" estadoEn"+x.idMantenimiento+"' attr='estado'  style='width:100%;'><option value='propia'>Propia</option><option value='ministerioDeporte'>Del ministerio del deporte</option></select></td><td><select class='editar__enlaces__selector"+x.idMantenimiento+" recursosEn"+x.idMantenimiento+"' attr='tipoRecursos'  style='width:100%;'><option value='recursosPublicos'>Recursos públicos</option><option value='autogestion'>Recursos de autogestión</option><option value='otras'>Otras fuentes de financiamiento</option></select></td><td><select class='editar__enlaces__selector"+x.idMantenimiento+" tipoIntervencion"+x.idMantenimiento+"' attr='tipoIntervencion'  style='width:100%;'><option value='gastosMantenimiento'>Gastos por mantenimiento de insfraestructura</option><option value='Gastos de rehabilitacion'>Gastos de rehabilitación</option></select></td><td><select class='editar__enlaces__selector"+x.idMantenimiento+" detallarTipoIn"+x.idMantenimiento+"' attr='detallarTipoIn'  style='width:100%;'><option value='fachadasExteriores'>Fachadas exteriores</option><option value='interiores'>Interiores</option><option value='interiores'>Interiores</option><option value='cubiertas'>Cubiertas</option><option value='pisosInteriores'>Pisos interiores</option><option value='pisosExteriores'>Pisos exteriores</option><option value='pisosExteriores'>Pisos exteriores</option><option value='pisicinas'>Piscinas</option><option value='isntalacionesHi'>Instalaciones Hidrosanitarias de las edificaciones deportivas</option><option value='sistemaElectrico'>Sistema Eléctrico</option><option value='sistemaMecanico'>Sistema Mecanico</option></select></td><td><select class='editar__enlaces__selector"+x.idMantenimiento+" tipoMantenimiento"+x.idMantenimiento+"' attr='tipoMantenimiento'  style='width:100%;'><option value='preventivo'>Preventivo</option><option value='correctivo'>Correctivo</option></select></td><td><input type='text' class='editar__enlaces"+x.idMantenimiento+"' attr='materialesServicios' value='"+x.materialesServicios+"' style='width:100%;'/></td></td><td><input type='text' class='editar__enlaces"+x.idMantenimiento+"' attr='fechaUltimo' value='"+x.fechaUltimo+"' style='width:100%;'/></td></tr>");

											$(".provinciasEn"+x.idMantenimiento).val(x.provincia);
											$(".estadoEn"+x.idMantenimiento).val(x.estado);
											$(".recursosEn"+x.idMantenimiento).val(x.tipoRecursos);
											$(".tipoIntervencion"+x.idMantenimiento).val(x.tipoIntervencion);
											$(".detallarTipoIn"+x.idMantenimiento).val(x.detallarTipoIn);
											$(".tipoMantenimiento"+x.idMantenimiento).val(x.tipoMantenimiento);

											$(".editar__enlaces__selector"+x.idMantenimiento).on('change', function () {
												...
												paqueteDeDatos.append('tipo',"actualizaOpciones__m");
												paqueteDeDatos.append('campo',idContador);
											...
											$(".editar__enlaces"+x.idMantenimiento).on('blur', function () {
					...
					for (c of arrayInformacionSecond[w]) {
				  		...
				  		switch (parametro6) {
				  			...
				  			case "poa__actividadesDeportivas":
				  				...
				  				enviar__eventos__totales__doceavos($(".editar__principal__eventos__necesarios"),"editar__eventos__inicial__tables__modificaciones","formulario__reconsiliados__n");

				  				enviar__eventos__totales__doceavos__modificaciones__dos($(".editar__principal__eventos__necesarios__dos__modificaciones"),"editar__eventos__inicial__tables__modificaciones__dos__modificaciones","formulario__reconsiliados__n");
				  		...
				  		switch (parametro6) {
				  			...
				  			case "actividad__administrativa":
				  				...
				  				guardarElementosGeneral__modificaciones($("#guardarMatriz"+c.idProgramacionFinanciera),c.idProgramacionFinanciera,"actividadesAdministrativas__modificaciones__reales",$(".reload__"+c.idProgramacionFinanciera));
