...
$(selector).change(function () {
	...
	if (((($("#actividad__modificaciones__destinos").val()==4 && comparador=="sueldos")  || $("#actividad__modificaciones__destinos").val()=="sueldosD") && ($("#identificadorPaginaReal").val()=="honorarios" || $("#identificadorPaginaReal").val()=="sueldos" || $("#identificadorPaginaReal").val()=="diferentes")) && $("#actividad__modificaciones__destinos").val()!=2) {
...
$(selector).change(function () {
	...
	if ((parametro4=="honorarios" || parametro4=="sueldos") && ($("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="4" || $("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="honorariosD" || $("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="sueldosD") || ($("#identificadorPaginaReal").val()=="diferentes" && $("#actividad__modificaciones__destino__modificaciones2__seleccion").val()=="honorariosD")) {
		...
		$.ajax({
			...
			data: {idOrganismo: idOrganismo, indicador: indicador, item:$(this).val(),idActividad:$("#actividad__modificaciones__destinos").val(),eventos_intervencion_o:$("#eventos_intervencion__seleccion").val()},
			dataType: 'html',
			type: 'POST',
			url: 'modelosBd/validaciones/selector.modelo.php'
