<?php
	...
	switch ($tipo) {
	   ...
	   break;
		...
		case  "actualiza__catalogoContraloria__paid":
	   ...
	   case  "actualizar_matrices_generales_auxiliares_JN":
		
			$conexionRecuperada= new conexion();
			$conexionEstablecida=$conexionRecuperada->cConexion();	
		
			$query="UPDATE poa_paid_matrices_juegos_nacionales SET `descripcion` = '$descripcion', `valorTotal` = '$valorTotal',`fecha` = '$fecha_actual' WHERE `idMatriz` = '$idMatriz';";
		...
		case  "actualizar_matriz_general_acreditaciones_JN":
		
			$conexionRecuperada= new conexion();
			$conexionEstablecida=$conexionRecuperada->cConexion();	
		
			$query="UPDATE poa_paid_matrices_juegos_nacionales SET `descripcion` = '$descripcion', `cantidad` = '$cantidad', `valorUnitario` = '$valorUnitario', `valorTotal` = '$valorTotal',`fecha` = '$fecha_actual' WHERE `idMatriz` = '$idMatriz';";
			$resultado= $conexionEstablecida->exec($query);
