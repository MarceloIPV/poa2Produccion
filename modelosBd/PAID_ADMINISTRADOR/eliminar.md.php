<?php
	...
	switch ($tipo) {
		...
		case  "eliminarTipoInfraestructura":
			...
			$query="DELETE FROM poa_paid_tipo_infraestructura WHERE id_tipo_infraestructura='$idtabla';";
		...
		case  "eliminarEstadoPropiedadPaid":

			$conexionRecuperada= new conexion();
	 		$conexionEstablecida=$conexionRecuperada->cConexion();	

			$query="DELETE FROM poa_paid_estado_propiedad WHERE id_estado_propiedad='$idtabla';";
