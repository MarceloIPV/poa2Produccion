...
$objeto1= new usuarioAcciones();
	...
	$cantidad=$objeto1->getObtenerInformacionGeneral("SELECT count(*) as num FROM poa_disminuciondestino where mes='$mes' ");
...
$sql ="INSERT INTO poa_disminuciondestino (`actividad`, `item`,  `itemPresupuestario`, `mes`, `monto`, `estado`,`estado_montos`)VALUES ('$actividad', '$item', '$codigo', '$mes', '$monto', 'A','MONTOS');";
