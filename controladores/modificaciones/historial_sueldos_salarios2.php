...
<?php 
	...
	$indicadorInformacion=$objeto->getObtenerInformacionGeneral("select * from poa_modificacion_organismo_actividades where idOrganismo='$idOrganismoSession' and actividadOrigen=2 order by actividadOrigen asc");
